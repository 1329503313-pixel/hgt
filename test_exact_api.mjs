// Run inside container: node test_exact_api.mjs
...
async function main() {
  ...
  await pool.query(
    "INSERT INTO soups (id, title, author, type, summary, cover_image, is_original, surface, supplemental_surfaces, bottom, supplemental_bottoms, host_manual, is_surface_public, is_bottom_public, creator_id, creator_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
    [
      id,
      "模仿API标题",
      "作者",
