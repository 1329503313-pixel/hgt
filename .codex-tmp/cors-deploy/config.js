...
export const config = {
    ...
    aliyunOssPublicEndpoint: process.env.ALIYUN_OSS_PUBLIC_ENDPOINT ?? "https://oss-cn-beijing.aliyuncs.com",
    ...
    emailVerificationSecret: readSecret("EMAIL_VERIFICATION_SECRET", "EMAIL_VERIFICATION_SECRET_FILE")
