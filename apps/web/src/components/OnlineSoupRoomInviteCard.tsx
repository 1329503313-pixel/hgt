  ...
  return (
    ...
    >
      ...
      <span className="block space-y-2.5 p-4">
        ...
        <span className="flex items-center gap-2 text-xs text-muted"><Users size={14} className="text-emerald-600" /><span>房间人数</span><strong className="text-ink">{invite.participantCount ?? invite.playerCount + 1}/{invite.participantCapacity ?? invite.playerCapacity + 1}</strong></span>
