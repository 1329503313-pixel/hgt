      ...
      <aside className="detail-desktop-floating-actions hidden lg:grid" aria-label="作品操作">
        <div className="card p-4">
          ...
          <div className="mt-4 grid gap-2">
            {soup.canViewFull && isReviewApproved && <button className="btn btn-primary w-full" onClick={() => { if (!user) { openAuth(); return; } setRoomForm({ name: soup.title, type: "public", password: "", hostMode: "human" }); setShowRoomCreate(true); }}><DoorOpen size={17} />开房间</button>}
